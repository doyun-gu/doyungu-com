// ============================================================
// Vision Blog Posts — same format as life-posts.js
// See BLOG.md for full documentation.
// ============================================================

const visionPosts = [
  {
    slug: "where-i-am-heading",
    title: "Where I Am Heading",
    date: "February 2026",
    summary: "Building technology that matters — from automotive to agriculture.",
    content: [
